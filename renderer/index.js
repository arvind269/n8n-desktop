...
console.log("Imported 'exec' from 'child_process' module");
...
function renderer(controller, bgEnabled) {
  ...
  console.log("Loading n8n URL...", `http://localhost:${process.env.N8N_PORT}`);
  window.webContents
      .loadURL(`http://localhost:${process.env.N8N_PORT}`)
      .catch(console.log);
